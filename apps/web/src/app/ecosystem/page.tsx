  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      ...
      <p className="mt-2 text-text-muted">
        How domains connect through real, verified relationships between organisations.{' '}
        {domainEdges.length} cross-domain connections across {crossLinked.length} organisations.
      </p>
        ...
        <div className="mt-6">
          ...
          <div className="mt-3 space-y-2">
            {domainEdges.map((e) => (
              ...
              >
                <span>
                  <span className="font-medium">{domainMap.get(e.a)?.label ?? e.a}</span>
                  <span className="mx-2 text-text-muted">↔</span>
                  <span className="font-medium">{domainMap.get(e.b)?.label ?? e.b}</span>
                </span>
      ...
      <div className="mt-8">
        <h2 className="text-xl font-bold">Cross-linked organisations ({crossLinked.length})</h2>
